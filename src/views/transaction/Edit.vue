...
export default {
    setup() {
        ...
        onMounted(() => {
            axios.get(`https://project-transaction-client-api.herokuapp.com/data/${route.params.id}`)
            .then((result) => {
        ...
        function update() {
            axios.put(
                `https://project-transaction-client-api.herokuapp.com/data/${route.params.id}`,
                transaction
            )
            .then(() => {
                router.push({
